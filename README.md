...
```bash
npm install
npm test                     # 226 tests, offline, ~0.5s
...
Everything that leaves the process goes through that function. It is why 226 tests run
...
npm install && npm test              # 226 tests, offline, ~0.5s
...
|                                                               |                                          |
| ------------------------------------------------------------- | ---------------------------------------- |
| `npm test`                                                    | 226 tests, offline, no platform          |
